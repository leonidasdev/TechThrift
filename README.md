...
A production-ready full-stack application that compares product prices across major Spanish retailers: Amazon.es, MediaMarkt, PCComponentes, and El Corte Inglés.
